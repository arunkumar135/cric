...
//function assign(){
   ...
   {
    x.setAttribute("src","GT.jpg");
}
else if(t == 5)
   {
    x.setAttribute("src","MI.webp");
}
else if(t == 6)
   {
   ...
   {
    y.setAttribute("src","GT.jpg");
}
else if(u == 5)
   {
    y.setAttribute("src","MI.webp");
}
else if(u == 6)
   {
